...
def getWikiCFPConferences(category):
  ...
  'cookie': """your cookie value ( you can get that from your web page) """
    ...
    for i in range(pages):
        print("pagina "+str(i+1)+"/"+str(pages))
        if i != 0:
            html =""
...
def getWikiCFPConferenceDetails(link):
  ...
  'cookie': """your cookie value ( you can get that from your web page) """
    ...
    if html == "":
        return Conference.Conference(link,"","","","","","","","","","","")
    ...
    temas = ""
    try:
        temas = soup.find("p", string="Topics of interest include, but are not limited to, the following").find_next_sibling().text
    except:
        pass
    ...
    try:
        ...
        tags = category_table.text.strip().replace("\xa0", "").replace("Categories", "")
    except:
        pass
    precio = ""

    return Conference.Conference(link,titulo,desc,temas,fecha,ubicacion,fechaEntrega,organizacion,tipo,tags,precio)
